            ...
            <div class="col-md-6">
                ...
                <div class="step" id="step2" style="display: none">
                    ...
                    <div class="d-flex justify-content-between mb-3 input-group-text">
                        <div>
                            <label for="silverQuantity" class="fw-bold"> Silver</label> <span
                                class="input-group-text text-danger"> $100</span>
                        </div>
                    ...
                    <div class="d-flex justify-content-between mb-3 input-group-text">
                        <div>
                            <label for="silverQuantity" class="fw-bold">Gold</label> <span
                                class="input-group-text text-danger"> $200</span>
                        </div>
                        <div class="input-group">
                            <div class="d-flex align-items-center">
                                <button class="btn btn-outline-secondary rounded-circle" type="button"
                    ...
                    <div class="d-flex justify-content-between mb-3 input-group-text">
                        <div>
                            <label for="silverQuantity " class="fw-bold">Ticket for five</label> <span
                                class="input-group-text text-danger d-flex justify-content-center"> $100</span>
                        </div>
                        <div class="input-group">
                            <div class="d-flex align-items-center">
                                <button class="btn btn-outline-secondary rounded-circle" type="button"
